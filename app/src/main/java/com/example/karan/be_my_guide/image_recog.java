...
public class image_recog extends AppCompatActivity implements AdapterView.OnItemSelectedListener {

    private static final String TAG = "MainActivity";
    private static final int RECORD_REQUEST_CODE = 101;
    private static final int CAMERA_REQUEST_CODE = 102;

    private static final String CLOUD_VISION_API_KEY = "AIzaSyB3jfRx5uq3LBay5OEXRiEmklO77e-7ghs";
    ...
    private String[] visionAPI = new String[]{"LABEL_DETECTION", "LOGO_DETECTION", "SAFE_SEARCH_DETECTION","LANDMARK_DETECTION"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activiy_image);
    ...
    private String formatAnnotation(List<EntityAnnotation> entityAnnotation) {
        ...
        if (entityAnnotation != null) {
            for (EntityAnnotation entity : entityAnnotation) {
                message = message + "    " + entity.getDescription() + " " + (int)(entity.getScore()*100)+ " %";
                message += "\n";
            }
        } else {
